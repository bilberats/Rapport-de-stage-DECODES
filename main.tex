...
\begin{document}
	...
	Dans cette partie, nous allons voir les travaux précédents sur l'étude de la consommation énergétique des résolveurs DNS, ainsi que les travaux connexes à ce qui a été fait dans ce stage. Cette partie est importante pour comprendre les contributions de ce stage et les limites des travaux précédents.
