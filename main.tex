...
\begin{document}
	...
	Diagrammes détaillés des différents types de mesures.
	Sanity check 
	...
	Outils utilisés pour analyser les résultats, les différentes analyses réalisées, les problèmes rencontrés et comment ils ont été résolus.
	(Format des mesures obtenus)
	Script de traitement des données, etc.
	problemes rencontrés : 
	- temps de traitement


	\subsubsection{Consommation par protocole}
	...
	---
	\subsubsection{Paquets envoyés et reçus par le résolveur}
	...
	---
	\subsubsection{Distribution des TTL}
	...
	---
	\subsubsection{Types de requêtes effectuées par le résolveur}
